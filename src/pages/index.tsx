        ...
        <div className="section download" id="download">
          ...
          <div className="buttons-row three">
            <Button
              ...
              withBackground
              title="https://github.com/lightningrodlabs/acorn/releases/download/v2.1.1-alpha/Acorn-2.1.1-alpha.dmg"
              onClick={() => {
                window.open(
                  "https://github.com/lightningrodlabs/acorn/releases/download/v2.1.1-alpha/Acorn-2.1.1-alpha.dmg",
                  "_blank"
                );
              }}
            />
            <Button
              ...
              withBackground
              title="https://github.com/lightningrodlabs/acorn/releases/download/v2.1.1-alpha/Acorn.Setup.2.1.1-alpha.exe"
              onClick={() => {
                window.open(
                  "https://github.com/lightningrodlabs/acorn/releases/download/v2.1.1-alpha/Acorn.Setup.2.1.1-alpha.exe",
                  "_blank"
                );
              }}
            />
