        ...
        <div className="section download" id="download">
          ...
          <div className="buttons-row three">
            <Button
              ...
              withBackground
              title="https://github.com/lightningrodlabs/acorn/releases/download/v1.1.1-alpha/Acorn-1.1.1-alpha.dmg"
              onClick={() => {
                window.open(
                  "https://github.com/lightningrodlabs/acorn/releases/download/v1.1.1-alpha/Acorn-1.1.1-alpha.dmg",
                  "_blank"
                );
              }}
            />
            <Button
              ...
              withBackground
              title="https://github.com/lightningrodlabs/acorn/releases/download/v1.1.1-alpha/Acorn.Setup.1.1.1-alpha.exe"
              onClick={() => {
                window.open(
                  "https://github.com/lightningrodlabs/acorn/releases/download/v1.1.1-alpha/Acorn.Setup.1.1.1-alpha.exe",
                  "_blank"
                );
              }}
            />
            <Button
              ...
              withBackground
              title="https://github.com/lightningrodlabs/acorn/releases/download/v1.1.1-alpha/Acorn-1.1.1-alpha.AppImage"
              onClick={() => {
                window.open(
                  "https://github.com/lightningrodlabs/acorn/releases/download/v1.1.1-alpha/Acorn-1.1.1-alpha.AppImage",
                  "_blank"
                );
              }}
            />
