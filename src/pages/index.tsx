        ...
        <div className="section download" id="download">
          ...
          <div className="buttons-row three">
            <Button
              ...
              withBackground
              title="https://github.com/lightningrodlabs/acorn/releases/tag/v3.0.0-alpha"
              onClick={() => {
                window.open(
                  "https://github.com/lightningrodlabs/acorn/releases/tag/v3.0.0-alpha",
                  "_blank"
                );
              }}
            />
            <Button
              ...
              withBackground
              title="https://github.com/lightningrodlabs/acorn/releases/download/v3.0.0-alpha/Acorn.Setup.3.0.0-alpha.exe"
              onClick={() => {
                window.open(
                  "https://github.com/lightningrodlabs/acorn/releases/download/v3.0.0-alpha/Acorn.Setup.3.0.0-alpha.exe",
                  "_blank"
                );
              }}
            />
            <Button
              ...
              withBackground
              title="https://github.com/lightningrodlabs/acorn/releases/download/v3.0.0-alpha/Acorn-3.0.0-alpha.AppImage"
              onClick={() => {
                window.open(
                  "https://github.com/lightningrodlabs/acorn/releases/download/v3.0.0-alpha/Acorn-3.0.0-alpha.AppImage",
                  "_blank"
                );
              }}
            />
